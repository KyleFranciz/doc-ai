...
SummarizerPrompt = ChatPromptTemplate.from_messages(
    ...
    [
        ...
        on the web and helping to summarize and organize information in valid Markdown. For Inline code words make sure that they have single backticks,
        and for the code blocks make sure that they have tripple backticks. If you have single words in formated in
