...
def getKnowledgeFromDoc(user_input : str, session_id: str): # todo: Add UserId param later to use the userID when fetching the data
...
async def getKnowledgeFromDocStreaming(user_input : str, session_id: str): # get input from the user that doc should look into
    """
    ...
    """
    try: 
        print(f"Streaming response from Doc to the User")
        ...
        print(f"Error occurred in getKnowledgeFromDocStreaming: {traceback.format_exc()}")
